...
def get_random_title() -> str:
    '''请求随机题目'''
    try:
        get_random_data = httpx.post("https://leetcode.cn/graphql", json={
...
def get_today_title() -> str:
    '''获取今日的每日一题标题'''
    try:
        get_today_data = httpx.post("https://leetcode.cn/graphql", json={
...
def get_search_title(keyword) -> str:
    ...
    try:
        get_search_data = httpx.post("https://leetcode.cn/graphql", json={
...
def get_sub_problem_data(titleSlug) -> list:
    ...
    try:
        ...
        raise e
    try:
        get_problem_data = httpx.post("https://leetcode.cn/graphql", json={
        ...
        problem_content = html_template.replace("【content】", (problem_content.replace('\\"', '"'))).replace("【title】",
                                                                                                            problem_title)
        # 题目链接
        problem_link = "本题链接：" + f"https://leetcode.cn/problems/{titleSlug}/"
