...
def get_user_question_progress(userSlug):
    ...
    try:
        get_data = httpx.post("https://leetcode.cn/graphql", json={
            ...
            "query": "query userQuestionProgress($userSlug: String!) {  userProfileUserQuestionProgress(userSlug: "
                     "$userSlug) {    numAcceptedQuestions {      difficulty      count      __typename    }    "
                     "numFailedQuestions {      difficulty      count      __typename    }    numUntouchedQuestions { "
                     "     difficulty      count      __typename    }    __typename  }}"
        })
    ...
    try:
        get_data = httpx.post("https://leetcode.cn/graphql", json={
            ...
            "query": "query profileArticles($userSlug: String!, $skip: Int, $first: Int) {\n  solutionArticles("
                     "userSlug: $userSlug, skip: $skip, first: $first) {\n    edges {\n      node {\n        title\n  "
                     "      slug\n        question {\n          title\n          titleSlug\n          "
                     "translatedTitle\n          questionFrontendId\n          __typename\n        }\n        "
                     "upvoteCount\n        topic {\n          commentCount\n          __typename\n        }\n        "
                     "__typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"
    ...
    try:
        get_data = httpx.post("https://leetcode.cn/graphql", json={
            ...
            "query": "query userMedals($userSlug: String!) {\n  userProfileUserMedals(userSlug: $userSlug) {\n    "
                     ...
                     "   current {\n      ...medalNodeFragment\n      __typename\n    }\n    next {\n      "
                     "...medalNodeFragment\n      __typename\n    }\n    __typename\n  }\n  userProfileUserNextMedal("
                     "userSlug: $userSlug) {\n    ...medalNodeFragment\n    __typename\n  }\n}\n\nfragment "
                     "medalNodeFragment on MedalNodeV2 {\n  name\n  obtainDate\n  category\n  config {\n    icon\n    "
                     "iconGif\n    iconGifBackground\n    __typename\n  }\n  progress\n  id\n  year\n  month\n  "
                     "__typename\n}\n"
        })
