...
_matcher = on_alconna(
    Alconna(
        ...
        Option("-r|--r18", action=store_true, help_text="是否发送r18"),
        Option("-noai", action=store_true, help_text="是否过滤ai图"),
    ),
    aliases={".ZXPIX.get"},
    priority=5,
    block=True,
...
async def _(
    ...
    if num.result > 10:
        await MessageUtils.build_message("一次最多10张哦...").finish()
    ...
    if (
        ...
        await MessageUtils.build_message("色色哒咩！死刑！去死！私聊！").finish()
